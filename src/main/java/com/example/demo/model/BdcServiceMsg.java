...
public class BdcServiceMsg implements Serializable {
  ...
  @ApiModelProperty(value = "前端地址", name = "backgroundUrl", example = "http://192.168.0.61:8800", dataType = "String")
...
/*  @Column(name = "deploy_state")
  @ApiModelProperty(value = "部署状态", name = "deployState", example = "暂未测试接口,目前机器部署测试模式", dataType = "String")
